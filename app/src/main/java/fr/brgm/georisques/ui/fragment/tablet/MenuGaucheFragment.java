 ...
 */
/*
 * Fragment for landscape orientation
 */
public class MenuGaucheFragment extends Fragment implements MenuView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_menu_gauche, container, false);
